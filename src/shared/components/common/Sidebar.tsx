...
export default function Sidebar() {
  ...
  return (
    <>
      <aside className="fixed top-0 left-0 flex h-full w-64 flex-col border-line-outline border-r bg-components-fill-standard-primary">
        {/* 로고 */}
        <div className="border-line-divider border-b px-spacing-600 py-spacing-500">
          <Link href="/" className="flex items-center gap-spacing-300">
