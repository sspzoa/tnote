...
export const useAssignmentTaskHandlers = (refetch: () => void) => {
  ...
  const handlePostpone = useCallback(
    ...
    [setSelectedTask, setPostponeDate, setPostponeNote, setShowPostponeModal],
  );
  ...
  const handleComplete = useCallback(
    ...
    [setSelectedTask, setShowCompleteModal],
  );
  ...
  const handleMarkInsufficient = useCallback(
    ...
    [setStatus, toast, refetch, confirm],
  );
  ...
  const handleViewHistory = useCallback(
    ...
    [setSelectedTask, setShowHistoryModal],
  );
  ...
  const handleEditDate = useCallback(
    ...
    [setSelectedTask, setEditDate, setShowEditDateModal],
  );
