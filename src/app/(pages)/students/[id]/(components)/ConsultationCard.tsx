  ...
  return (
    <div className="print-break-inside-avoid border-border border-b last:border-b-0">
      <button
        ...
        className="flex w-full items-center justify-between gap-3 px-5 py-4 text-left transition-colors hover:bg-muted print:px-0 print:py-2">
        <span className="min-w-0 flex-1 truncate font-medium text-base text-foreground">{consultation.title}</span>
      ...
      <div
        ...
        <div className="overflow-hidden print:overflow-visible">
          <div className="border-border border-t px-5 py-4 print:px-0 print:py-2">
            <p className="whitespace-pre-wrap text-base text-muted-foreground">{consultation.content}</p>
          </div>
        </div>
      </div>
    </div>
