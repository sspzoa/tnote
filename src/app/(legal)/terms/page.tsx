...
export default function TermsPage() {
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-spacing-600 px-spacing-600 py-spacing-800">
      <h1 className="font-bold text-content-standard-primary text-display">이용약관</h1>
      ...
      <div className="flex flex-col gap-spacing-600 text-body text-content-standard-secondary">
        <section className="flex flex-col gap-spacing-300">
          <h2 className="font-semibold text-content-standard-primary text-title">제1조 (목적)</h2>
          <p>
        ...
        <section className="flex flex-col gap-spacing-300">
          <h2 className="font-semibold text-content-standard-primary text-title">제2조 (서비스 제공자 정보)</h2>
        ...
        <section className="flex flex-col gap-spacing-300">
          <h2 className="font-semibold text-content-standard-primary text-title">제3조 (용어의 정의)</h2>
          <ul className="flex list-disc flex-col gap-spacing-200 pl-spacing-500">
        ...
        <section className="flex flex-col gap-spacing-300">
          <h2 className="font-semibold text-content-standard-primary text-title">제4조 (이용 계약의 체결)</h2>
        ...
        <section className="flex flex-col gap-spacing-300">
          <h2 className="font-semibold text-content-standard-primary text-title">제5조 (약관의 효력 및 변경)</h2>
          <ul className="flex list-decimal flex-col gap-spacing-200 pl-spacing-500">
        ...
        <section className="flex flex-col gap-spacing-300">
          <h2 className="font-semibold text-content-standard-primary text-title">제6조 (서비스의 제공)</h2>
        ...
        <section className="flex flex-col gap-spacing-300">
          <h2 className="font-semibold text-content-standard-primary text-title">제7조 (소유자의 의무)</h2>
          <ul className="flex list-decimal flex-col gap-spacing-200 pl-spacing-500">
            <li>
        ...
        <section className="flex flex-col gap-spacing-300">
          <h2 className="font-semibold text-content-standard-primary text-title">제8조 (이용자의 의무)</h2>
          <ul className="flex list-decimal flex-col gap-spacing-200 pl-spacing-500">
        ...
        <section className="flex flex-col gap-spacing-300">
          <h2 className="font-semibold text-content-standard-primary text-title">제9조 (서비스 이용 제한)</h2>
          <p>
        ...
        <section className="flex flex-col gap-spacing-300">
          <h2 className="font-semibold text-content-standard-primary text-title">제11조 (면책조항)</h2>
          <ul className="flex list-decimal flex-col gap-spacing-200 pl-spacing-500">
            <li>
        ...
        <section className="flex flex-col gap-spacing-300">
          <h2 className="font-semibold text-content-standard-primary text-title">제12조 (분쟁 해결)</h2>
          <ul className="flex list-decimal flex-col gap-spacing-200 pl-spacing-500">
