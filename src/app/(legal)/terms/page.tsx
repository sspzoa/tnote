...
export default function TermsPage() {
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-7 px-7 py-10">
      <h1 className="font-semibold text-5xl text-foreground tracking-tight">이용약관</h1>

      <div className="flex flex-col gap-7 text-muted-foreground text-sm leading-relaxed">
        <section className="flex flex-col gap-3">
          <h2 className="font-semibold text-2xl text-foreground">제1조 (목적)</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-semibold text-2xl text-foreground">제2조 (서비스 제공자 정보)</h2>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-semibold text-2xl text-foreground">제3조 (용어의 정의)</h2>
          <ul className="flex list-disc flex-col gap-2 pl-5">
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-semibold text-2xl text-foreground">제4조 (이용 계약의 체결)</h2>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-semibold text-2xl text-foreground">제5조 (약관의 효력 및 변경)</h2>
          <ul className="flex list-decimal flex-col gap-2 pl-5">
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-semibold text-2xl text-foreground">제6조 (서비스의 제공)</h2>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-semibold text-2xl text-foreground">제7조 (소유자의 의무)</h2>
          <ul className="flex list-decimal flex-col gap-2 pl-5">
            <li>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-semibold text-2xl text-foreground">제8조 (이용자의 의무)</h2>
          <ul className="flex list-decimal flex-col gap-2 pl-5">
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-semibold text-2xl text-foreground">제9조 (서비스 이용 제한)</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-semibold text-2xl text-foreground">제10조 (서비스 해지 및 데이터 삭제)</h2>
          <ul className="flex list-decimal flex-col gap-2 pl-5">
            <li>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-semibold text-2xl text-foreground">제11조 (면책조항)</h2>
          <ul className="flex list-decimal flex-col gap-2 pl-5">
            <li>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-semibold text-2xl text-foreground">제12조 (분쟁 해결)</h2>
          <ul className="flex list-decimal flex-col gap-2 pl-5">
