    ...
    <div className="mx-auto max-w-3xl px-spacing-600 py-spacing-800">
      ...
      <div className="space-y-spacing-600 text-body text-content-standard-secondary">
        <section>
          ...
          <p className="mt-spacing-200 rounded-radius-300 bg-components-fill-standard-secondary p-spacing-400 text-content-standard-tertiary text-footnote">
        ...
        <section>
          ...
          <p className="mb-spacing-200">서비스는 원활한 운영을 위해 다음과 같이 개인정보를 국외로 이전하고 있습니다:</p>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse border border-line-divider text-footnote">
              <thead>
                <tr className="bg-components-fill-standard-secondary">
          ...
          <p className="mt-spacing-300 text-content-standard-tertiary text-footnote">
        ...
        <section>
          <h2 className="mb-spacing-300 font-semibold text-content-standard-primary text-title">제8조 (쿠키의 사용)</h2>
          <ul className="list-decimal space-y-spacing-200 pl-spacing-500">
            <li>
        ...
        <section>
          ...
          <p className="mt-spacing-300">
            학생 및 관리자는 소유자에게 자신의 정보 열람, 정정, 삭제를 요청할 수 있으며, 소유자는 정당한 사유 없이 이를
            거부할 수 없습니다.
          </p>
          <div className="mt-spacing-300 rounded-radius-300 bg-components-fill-standard-secondary p-spacing-400">
            <p className="mb-spacing-200 font-medium text-content-standard-primary text-footnote">
              권리 행사 방법 및 접수처
            </p>
            <ul className="list-disc space-y-spacing-100 pl-spacing-500 text-footnote">
